...
export default function IdeaBinIOPopup({
  ...
  useEffect(() => {
    if (settingsMode && effectiveSettings) {
      ...
      setCollapsedScenarios(new Set()); // all expanded when opening
    }
  ...
  const [popupDims, setPopupDims] = useState({ width: 860, height: 740 });
      ...
      >
        ...
        {(mode === "export" || settingsMode) && (
          <div className="flex-1 overflow-y-auto p-2">
            ...
            {!settingsMode && ctx.dims?.legends?.length > 0 && (
